...
<div id="insertContents">
				  		 ...
				  		 <input type="hidden" id="artistGender" name="artistGender" value="${artistDeleteInfoDetail.artist.artistGender }"/>
									  	...
									  	<div class="col-sm-2 col-form-label">
						                   ...
						                   <div class="col-sm-10" style="padding-top:115px;">
						                       <button type="button" class="btn ko_name btn btn-outline-secondary profileImageUpdateBtn" id="profileImageUpdateBtn" style=" margin-right : 530px;">
						                       		<c:if test="${artistDeleteInfoDetail.artist.artistImg == null }">프로필 사진 등록</c:if>
						                       		<c:if test="${artistDeleteInfoDetail.artist.artistImg != null }">프로필 사진 변경</c:if>
						                       	</button>
							  ...
							  <c:if test="${result == 0 }">
								  <button type="submit" class="btn btn-primary" onclick="javascript: form.action='artistDeleteDo'">삭제</button> &nbsp;
								  <button type="submit" class="btn btn-danger" onclick="javascript: form.action='artistDeleteRejectDo'">반려</button> &nbsp;
								  <button type="button" class="btn btn-secondary goOut">나가기</button>
							  </c:if>
							  <c:if test="${result == 1 }">
								  <button type="submit" class="btn btn-primary" onclick="javascript: form.action='artistDeleteDo'" disabled>삭제</button> &nbsp;
								  <button type="submit" class="btn btn-danger" onclick="javascript: form.action='artistDeleteRejectDo'" disabled>반려</button> &nbsp;
								  <button type="button" class="btn btn-secondary goOut">나가기</button>
									<br><br>
