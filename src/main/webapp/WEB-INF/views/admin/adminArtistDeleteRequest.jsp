...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/admin/adminArtistDeleteRequest.css">
<!-- JS -->
<script type="text/javascript" src="https://code.jquery.com/jquery-3.6.0.min.js" ></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/admin/adminArtistDeleteRequest.js"></script>
					        ...
					        <div class="collapse show" id="home-collapse">
					          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
								  ...
								  <span class="visually-hidden">unread messages</span></span>
				           		 ...
				           		 <li><a href="artistDeleteRequest" class="link-dark rounded position-relative checkThis">삭제 요청
...
<c:if test="${artistDeleteAll != '[]' }">
<c:forEach items="${artistDeleteAll }" var="artistDeleteAll">
  <div class="col">
    <div class="card h-100">
    
    <c:if test="${artistDeleteAll.artist.artistImg !=null }">
      <img src="${artistDeleteAll.artist.artistImg }" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
    <c:if test="${artistDeleteAll.artist.artistImg ==null }">
      ...
      <div class="card-body border-top my-3">
        <h5 class="card-title">${artistDeleteAll.artist.artistName }</h5>
        <br>
        <c:set var="result" value="${artistDeleteAll.result }"/>
        <c:choose>
      ...
      <input type="hidden" name="delete_num" value="${artistDeleteAll.delete_num }">
      <input type="hidden" name="result" value="${artistDeleteAll.result }">
      <button class="btn artistDeleteBtn" style="width : 100%; padding : 0">
     <div class="card-footer artistDelete">
...
<c:if test="${artistDeleteNotYet != '[]' }">
<c:forEach items="${artistDeleteNotYet }" var="artistDeleteNotYet">
  <div class="col">
    <div class="card h-100">
    
    <c:if test="${artistDeleteNotYet.artist.artistImg !=null }">
      <img src="${artistDeleteNotYet.artist.artistImg }" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
    <c:if test="${artistDeleteNotYet.artist.artistImg ==null }">
      <img src="${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
      ...
      <div class="card-body border-top my-3">
        <h5 class="card-title">${artistDeleteNotYet.artist.artistName }</h5>
        <br>
    	    <p class="card-text" style="color:red">아직 처리되지 않은 <br> 요청사항입니다.</p>
      </div>
      <form action="artistDelete" method="post">
      <input type="hidden" name="delete_num" value="${artistDeleteNotYet.delete_num }">
      <input type="hidden" name="result" value="${artistDeleteNotYet.result }">
      <button class="btn artistDeleteBtn" style="width : 100%; padding : 0">
     <div class="card-footer artistDelete">
         <small class="text-muted">Artistar</small>
      </div>
...
<c:if test="${artistDeleteOk != '[]' }">
<c:forEach items="${artistDeleteOk }" var="artistDeleteOk">
  <div class="col">
    <div class="card h-100">
    
    <c:if test="${artistDeleteOk.artist.artistImg !=null }">
      <img src="${artistDeleteOk.artist.artistImg }" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
    <c:if test="${artistDeleteOk.artist.artistImg ==null }">
      <img src="${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
      ...
      <div class="card-body border-top my-3">
        <h5 class="card-title">${artistDeleteOk.artist.artistName }</h5>
        <br>
    	    <p class="card-text">처리된 요청사항입니다.</p>
      </div>
      <form action="artistDelete" method="post">
      <input type="hidden" name="delete_num" value="${artistDeleteOk.delete_num }">
      <input type="hidden" name="result" value="${artistDeleteOk.result }">
      <button class="btn artistDeleteBtn" style="width : 100%; padding : 0">
     <div class="card-footer artistDelete">
         <small class="text-muted">Artistar</small>
      </div>
...
<c:if test="${artistDeleteNope != '[]' }">
<c:forEach items="${artistDeleteNope }" var="artistDeleteNope">
  <div class="col">
    <div class="card h-100">
    
    <c:if test="${artistDeleteNope.artist.artistImg !=null }">
      <img src="${artistDeleteNope.artist.artistImg }" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
    <c:if test="${artistDeleteNope.artist.artistImg ==null }">
      <img src="${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
      ...
      <div class="card-body border-top my-3">
        <h5 class="card-title">${artistDeleteNope.artist.artistName }</h5>
        <br>
    	    <p class="card-text" style="color:blue">반려된 요청사항입니다.</p>
      </div>
      <form action="artistDelete" method="post">
      <input type="hidden" name="delete_num" value="${artistDeleteNope.delete_num }">
      <input type="hidden" name="result" value="${artistDeleteNope.result }">
      <button class="btn artistDeleteBtn" style="width : 100%; padding : 0">
     <div class="card-footer artistDelete">
         <small class="text-muted">Artistar</small>
      </div>
