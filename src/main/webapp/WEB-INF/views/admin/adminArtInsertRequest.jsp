...
<c:forEach items="${artInsertNotYet }" var="artInsertNotYet">
  <div class="col">
    ...
    <c:if test="${artInsertNotYet.artinfo_img !=null }">
      <img src="${artInsertNotYet.artinfo_img }" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
    <c:if test="${artInsertNotYet.artinfo_img ==null }">
      <img src="${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
...
<c:forEach items="${artInsertOk }" var="artInsertOk">
  <div class="col">
    ...
    <c:if test="${artInsertOk.artinfo_img !=null }">
      <img src="${artInsertOk.artinfo_img }" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
    <c:if test="${artInsertOk.artinfo_img ==null }">
      <img src="${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
...
<c:forEach items="${artInsertNope }" var="artInsertNope">
  <div class="col">
    ...
    <c:if test="${artInsertNope.artinfo_img !=null }">
      <img src="${artInsertNope.artinfo_img }" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
    <c:if test="${artInsertNope.artinfo_img ==null }">
      <img src="${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png" class="card-img-top" onerror="this.src='${pageContext.request.contextPath}/resources/image/admin/artist/artist_default.png'" style="padding : 10px; height : 255px;">
    </c:if>
