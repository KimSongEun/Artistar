...
<div class="container">
  ...
  <div class="col-3 col-xs-offset-1">
      ...
      <div class="col-4 insList">
              <a onclick="contentView(${postlist.postNum})" id="replyView" type="button" data-bs-toggle="modal" data-bs-target="#postContent">
       	 	 
       	 	 	<c:forEach items="${postlist.postImgList }" var="postImgList" varStatus="i">
							<c:choose>
							<c:when test="${i.count == 1 }">
							<div class="carousel-item active">
								<img src="${postImgList.postImg }" style="height:350px; width:300px; margin:10px;">
							</div>
							</c:when>
							<c:otherwise>
