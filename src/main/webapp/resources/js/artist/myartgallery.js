						...
						html += "<br>";
							...
							for(var j=0; j<3;j++){
								...
								for(var j=0; j<3;j++){
									...
									html += "<div class='artist_mainart'>";
									html += "<img class='mainart' src='resources/"+myGalleryArtistList[i].artInfo[j].artinfoImg+"' height='250px' onerror='this.src='resources/image/myartgallery/default_user.png''/>"
									html += "</div>"
								}
							}
